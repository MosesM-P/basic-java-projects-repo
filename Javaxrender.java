...
public class Javaxrender {

    static double heading = 0;
    static double pitch = 0;
    static BufferedImage lastRenderedImage = null;
    ...
    public static void main(String[] args) {
        ...
        renderPanel.addMouseMotionListener(new java.awt.event.MouseMotionAdapter(){
            public void mouseDragged(java.awt.event.MouseEvent e) {
                ...
                Point last = lastMousePosition[0];
                ...
                if (last != null) {
                    ...
                    headingSlider.setValue((int) Math.toDegrees(heading));
                    pitchSlider.setValue((int) Math.toDegrees(pitch));
        ...
        saveButton.addActionListener(e -> {
            if (lastRenderedImage != null) {
                try {
                    File outputfile = new File("render_output.png");
                    ImageIO.write(lastRenderedImage, "png", outputfile);
                    System.out.println("Frame saved -> render_output.png");
